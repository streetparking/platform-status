---
layout: post
title:  "Release Notes V 2.2.9 "
date:   2020-9-9 14:24:13 -0600
categories: release-note

---
Version 2.2.9 debuts upgraded functionality for user payment methods and a coupon removal tool for admins and three fixed up bugs
